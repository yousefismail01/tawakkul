...
//     /// 🔹 Draw Moon (Top Right, Properly Nested)
//     final double moonRadius = size.width * 0.15;
//     final Offset moonCenter = Offset(size.width * 0.88, size.height * 0.1);
...
//     _starPositions = List.generate(12, (index) {
//       return Offset(
...
//     _starOpacities = List.generate(12, (index) => random.nextDouble() * 0.5 + 0.5);
...
//             if (random.nextDouble() > 0.96) { // Subtle star flicker
...
//             moonGlowSize: sin(_controller.value * pi) * 0.08, // Slow glow pulse
//           ),
//         );
//       },
//     );
